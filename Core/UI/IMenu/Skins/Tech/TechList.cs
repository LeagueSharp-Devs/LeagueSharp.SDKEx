// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TechList.cs" company="LeagueSharp">
...
namespace LeagueSharp.SDK.UI.Skins.Tech
{
    ...
    /// </summary>
    public class TechList : ADrawable<MenuList>
    {
        #region Constants
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TechList" /> class.
        /// </summary>
        /// <param name="component">
        ///     The component.
        /// </param>
        public TechList(MenuList component)
            : base(component)
        {
