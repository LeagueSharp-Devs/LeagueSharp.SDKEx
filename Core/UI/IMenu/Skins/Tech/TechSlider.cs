// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TechSlider.cs" company="LeagueSharp">
...
namespace LeagueSharp.SDK.UI.Skins.Tech
{
    ...
    /// </summary>
    public class TechSlider : ADrawable<MenuSlider>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TechSlider" /> class.
        /// </summary>
        /// <param name="component">
        ///     The menu component
        /// </param>
        public TechSlider(MenuSlider component)
            : base(component)
        {
        }
